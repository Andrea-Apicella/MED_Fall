...
class FramesExtractor:
    def __init__(self, videos_folder: str, output_folder: str, labels: str, ground_truth_folder: str, frame_size) -> pd.DataFrame:
            ...
            for _, cam in enumerate((t1 := tqdm(videos, leave=False))):
                ...
                try:
                    ...
                    for f in trange(n_frames, leave=False):
                        ...
                        if not ret:
                            break
                        frame = np.array(tf.image.random_crop(value=frame, size=self.frame_size, seed=2))
...
if __name__ == "__main__":
    ...
    fe = FramesExtractor(
        ...
        output_folder       = f"{projectdir}/vision/vision_dataset/extracted_frames_random_crop",
    ...
    extracted_frames_resized = '/home/jovyan/work/persistent/extracted_frames_random_crop/'
